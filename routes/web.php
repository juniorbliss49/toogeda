...
Auth::routes();
  ...
  Route::get('/addcampaign', 'HomeController@addcampaign');
  Route::get('/viewcampaign/{id}', 'HomeController@viewcampaign');
  Route::get('/campaign/donate/{id}', 'HomeController@donate');
  Route::get('/campaign/insertdonation', 'HomeController@insertdonation');
  Route::get('/campaign/campaignadded', 'HomeController@campaignadded');
