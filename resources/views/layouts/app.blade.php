 <!DOCTYPE html>
    ...
    <script src="https://use.fontawesome.com/db38f8431a.js"></script>
        ...
        <title>Do-Good Toogedar RUN/WALK FOR SCOLIOSIS AWARENESS</title>
                ...
                <ul class="nav navbar-nav float-lg-right" style="margin-right: 180px">
                    @if(Auth::guest())
                        <li class="nav-item dropdown">
                            <a href="#" class="dropdown-toggle btn btn-primary btn-block" style="text-decoration: none;" data-toggle="dropdown" aria-expanded="false">Log In <span class="caret"></span></a>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="dropdown-toggle btn btn-primary btn-block" data-toggle="dropdown" style="text-decoration: none;" aria-expanded="false">Register <span class="caret"></span></a>
    ...
    <a class="nav-link dropdown-toggle d-inline-block" id="navbar-dropdown" href="/user/{{ Auth::user()->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        {{ Auth::user()->first_name }}
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbar-dropdown" style="text-decoration: none;">
